    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(choices=[('B', 'BRONZE'), ('G', 'GOLD'), ('S', 'SILVER')], default='B', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('P', 'pending'), ('C', 'complete'), ('F', 'fail')], default='p', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promotions', models.ManyToManyField(related_name='product', to='store.promotion')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
